    ...
    <div class="container py-5">
        <div class="card branch-card shadow-sm border-0 mx-auto">
            ...
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('branchs.update', $branchs->id) }}" method="POST" novalidate>
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="code" id="code"
                                    ...
                                    value="{{ $branchs->code }}" placeholder="เช่น BR001" required>
                                @error('code')
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    value="{{ $branchs->name }}" placeholder="ระบุชื่อสาขาเต็ม" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="tel" name="phone" id="phone"
                                    ...
                                    value="{{ $branchs->phone }}" placeholder="เช่น 02-XXX-XXXX">
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="license" id="license"
                                    ...
                                    value="{{ $branchs->license }}" placeholder="ระบุเลขใบอนุญาตประกอบการ">
                                @error('license')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="address" id="address" class="form-control custom-input @error('address') is-invalid @enderror"
                                    rows="3" placeholder="ระบุที่อยู่, ถนน, แขวง/ตำบล, เขต/อำเภอ, จังหวัด...">{{ old('address', $branchs->address ?? '') }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="form-check form-switch d-flex align-items-center gap-3">
                                    ...
                                    <input type="checkbox" name="active" id="active" value="1"
                                        ...
                                        {{ old('active', $branchs->active ?? 1) ? 'checked' : '' }}>

                                    <div>
                                        <label for="active" class="form-check-label fw-semibold">
                                            เปิดใช้งานสาขา
                                        </label>

                                        <div class="text-muted small">
                                            หากปิดใช้งาน สาขานี้จะไม่สามารถเลือกใช้งานในระบบได้
                                        </div>
                                    </div>
